 ...
 * @author louis
 */
public class TelaVanguardasPerguntas extends javax.swing.JFrame {
    static int idLogin;
    static Musica musica;
    /**
     * Creates new form TelaVanguardasPerguntas
     */
    public TelaVanguardasPerguntas(int idLogin, Musica musica) {
    ...
    private void dadaismoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dadaismoButtonActionPerformed
        int idVanguarda = 2;
        TelaPerguntas frame = new TelaPerguntas(idLogin, idVanguarda, musica);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVanguardasPerguntas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVanguardasPerguntas(idLogin, musica).setVisible(true);
            }
        });
    }
